...
public class Main {
    public static void main(String[] args) {
        // Creazione di un primo oggetto com.maggioli.salesanalyzer.model.Prodotto
        // new com.maggioli.salesanalyzer.model.Prodotto() invoca il costruttore della classe com.maggioli.salesanalyzer.model.Prodotto per creare una nuova istanza
        ...
        // Creazione di oggetti com.maggioli.salesanalyzer.model.ProdottoFisico e com.maggioli.salesanalyzer.model.ProdottoDigitale
        ...
        // Creazione di un secondo oggetto com.maggioli.salesanalyzer.model.Prodotto con un prezzo negativo per testare la validazione
//        com.maggioli.salesanalyzer.model.Prodotto prodottoConPrezzoNegativo = new com.maggioli.salesanalyzer.model.Prodotto("P005", "com.maggioli.salesanalyzer.model.Prodotto con Prezzo Negativo", "Test", -50.00);
//
//    Output ottenuto:
//        Exception in thread "main" java.lang.IllegalArgumentException: Il prezzo unitario non può essere negativo.
//                at com.maggioli.salesanalyzer.model.Prodotto.<init>(com.maggioli.salesanalyzer.model.Prodotto.java:25)
//        at Main.main(Main.java:13)

        // In questo caso stiamo accedendo direttamente agli attributi dell'oggetto com.maggioli.salesanalyzer.model.Prodotto perchè l'abbiamo reso pubblico
        ...
        laptop.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.ProdottoFisico
        System.out.println("---");
        smartphone.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.Prodotto
        System.out.println("---");
        libro.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.Prodotto
        System.out.println("---");
        libroJavaPDF.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.ProdottoDigitale
        System.out.println("---");
        maglietta.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.ProdottoFisico
        System.out.println("---");
        canzoneMP3.visualizzaDettagli(); // Chiamata al metodo visualizzaDettagli() della classe com.maggioli.salesanalyzer.model.ProdottoDigitale

        // Sconto sui prodotti
        System.out.println("\n--- Dimostrazione Interfaccia com.maggioli.salesanalyzer.interfaces.Scontabile ---");
        System.out.println("Prezzo originale Laptop: " + String.format("%.2f", laptop.getPrezzoUnitario()));
        laptop.applicaSconto(10); // Chiama il metodo implementato da com.maggioli.salesanalyzer.model.Prodotto
        ...
        // Creazione di oggetti com.maggioli.salesanalyzer.model.TransazioneVendita
        // Ogni transazione fa riferimento a un oggetto com.maggioli.salesanalyzer.model.Prodotto
        // *** Ora usiamo una List generica per memorizzare le TransazioniVendita ***
        // List<com.maggioli.salesanalyzer.model.TransazioneVendita> dichiara una lista che conterrà SOLO oggetti di tipo com.maggioli.salesanalyzer.model.TransazioneVendita
        // ArrayList<com.maggioli.salesanalyzer.model.TransazioneVendita> è un'implementazione concreta di List
        ...
        System.out.println("\n--- Dimostrazione Interfaccia com.maggioli.salesanalyzer.interfaces.ComparabilePerRicavo ---");
